 ...
 * 2 machines, the first machine should have insertstart=0 and the second insertstart=500000.
 * Additionally, the "insertcount" property, which is interpreted by Client, can be used to tell each instance of the
