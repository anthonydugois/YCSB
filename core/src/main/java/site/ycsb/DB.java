...
public abstract class DB {
	 ...
	 * @param options A Map of key/value pairs to specify query options.
	 * @param result  A Map of field/value pairs for the result.
	 * @return The status of the operation.
	 */
	public abstract Status read(String table, String key, Set<String> fields, Map<String, Object> options,
	...
	/**
	 * Insert a record in the database. Any field/value pairs in the specified values Map will be written into the
